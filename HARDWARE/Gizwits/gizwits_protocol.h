...
* @{
*/
#define PRODUCT_KEY "0a8dad8982cd4e5ca3ce68565a582571"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "8b0b18c3f83444ad935b6de19ff21a16"
...
#define Switch_LEN                           1
#define Switchtime_BYTEOFFSET                    0
#define Switchtime_BITOFFSET                     1
#define Switchtime_LEN                           1

#define G_temp_net_RATIO                         1
#define G_temp_net_ADDITION                      0
#define G_temp_net_MIN                           0
#define G_temp_net_MAX                           99
#define fanspeed_RATIO                         1
#define fanspeed_ADDITION                      0
#define fanspeed_MIN                           0
#define fanspeed_MAX                           10
#define Hour_RATIO                         1
#define Hour_ADDITION                      0
#define Hour_MIN                           0
#define Hour_MAX                           23
#define Mint_RATIO                         1
#define Mint_ADDITION                      0
#define Mint_MIN                           0
#define Mint_MAX                           59
#define temp_RATIO                         1
...
typedef struct {
    bool valueSwitch;
    bool valueSwitchtime;
    uint32_t valueG_temp_net;
    uint32_t valuefanspeed;
    uint32_t valueHour;
    uint32_t valueMint;
    uint32_t valuetemp;
    uint32_t valuehumi;
...
typedef struct {
    ...
    uint8_t flagSwitchtime:1;
    uint8_t flagG_temp_net:1;
    uint8_t flagfanspeed:1;
    uint8_t flagHour:1;
    uint8_t flagMint:1;
} attrFlags_t;
...
typedef struct {
    ...
    uint8_t valueG_temp_net;
    uint8_t valuefanspeed;
    uint8_t valueHour;
    uint8_t valueMint;
} attrVals_t;
