...
#define LCD_SDA        	GPIO_Pin_4	//PA7 MOSI--->>TFT --SDA/DIN
#define LCD_CS        	GPIO_Pin_1  //PA4--->>TFT --CS/CE

#define LCD_LED        	GPIO_Pin_12  //MCU_PB10--->>TFT --BL
#define LCD_RS         	GPIO_Pin_2	//PB1--->>TFT --RS/DC
#define LCD_RST     		GPIO_Pin_3	//PB0--->>TFT --RST

//#define LCD_CS_SET(x) LCD_CTRL->ODR=(LCD_CTRL->ODR&~LCD_CS)|(x ? LCD_CS:0)

//液晶控制口置1操作语句宏定义
#define	LCD_SCL_SET  	GPIOD->BSRR=LCD_SCL    
#define	LCD_SDA_SET  	GPIOD->BSRR=LCD_SDA   
...
//液晶控制口置0操作语句宏定义
#define	LCD_SCL_CLR  	GPIOD->BRR=LCD_SCL  
#define	LCD_SDA_CLR  	GPIOD->BRR=LCD_SDA 
